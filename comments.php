...
<div class="bt-comment-wrapper">
	...
	<?php if ( have_comments() ) : ?>
		<h6 class="bt-heading-comment"><?php esc_html_e( 'Post Comments:', 'chambeshi' ) ?></h6>
	...
	<?php
		...
		$args = array(
			...
			'name_submit'       => 'submit',
			'title_reply'       => '<span class="bt-label-reply">'.esc_html__( 'Leave A Comment', 'chambeshi' ).'</span>',
			...
			'comment_field' =>  '<div class="bt-form-message">
														...
														<textarea id="comment" class="bt-form-message__input" name="comment" cols="60" rows="6" aria-required="true" placeholder="'.esc_attr__('Start typing here','chambeshi').'">' . '</textarea>
													</div>',
