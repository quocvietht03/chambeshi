...
namespace ChambeshiElementorWidgets\Widgets\HighlightedHeading;
...
class Widget_HighlightedHeading extends Widget_Base
{
	...
	{
		return __('Highlighted Heading', 'chambeshi');
	}
	...
	protected function register_content_section_controls()
	{
		...
		$this->add_control(
			'before_text',
			[
				'label'       => esc_html__('Before Text', 'chambeshi'),
		...
		$this->add_control(
			'highlighted_text',
			[
				'label'       => esc_html__('Highlighted Text', 'chambeshi'),
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'default'     => esc_html__('Highlighted', 'chambeshi'),
			]
		);
		...
		$this->add_control(
			'after_text',
			[
				'label'       => esc_html__('After Text', 'chambeshi'),
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'default'     => '',
			]
