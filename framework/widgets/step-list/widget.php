<?php
namespace ChambeshiElementorWidgets\Widgets\StepList;
...
class Widget_StepList extends Widget_Base {
	...
	protected function register_layout_section_controls() {
		...
		$repeater->add_control(
			'step_btn_text', [
				'label' => __( 'Button Text', 'chambeshi' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'default' => '',
			]
		...
		$this->add_control(
			'list',
			[
				'label' => __( 'List Step', 'chambeshi' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'step_image' => Utils::get_placeholder_image_src(),
						'step_subtitle' => __( 'Sub title', 'chambeshi' ),
						'step_title' => __( 'This is step title 01', 'chambeshi' ),
						'step_desc' => __( 'This is description', 'chambeshi' ),
						'step_btn_text' => __( 'Read More', 'chambeshi' ),
						'step_btn_link' => '#'
					],
					[
						'step_image' => Utils::get_placeholder_image_src(),
						'step_subtitle' => __( 'Sub title', 'chambeshi' ),
						'step_title' => __( 'This is step title 02', 'chambeshi' ),
						'step_desc' => __( 'This is description', 'chambeshi' ),
						'step_btn_text' => __( 'Read More', 'chambeshi' ),
						'step_btn_link' => '#'
					],
					[
						'step_image' => Utils::get_placeholder_image_src(),
						'step_subtitle' => __( 'Sub title', 'chambeshi' ),
						'step_title' => __( 'This is step title 03', 'chambeshi' ),
						'step_desc' => __( 'This is description', 'chambeshi' ),
						'step_btn_text' => __( 'Read More', 'chambeshi' ),
						'step_btn_link' => '#'
					],
					[
						'step_image' => Utils::get_placeholder_image_src(),
						'step_subtitle' => __( 'Sub title', 'chambeshi' ),
						'step_title' => __( 'This is step title 04', 'chambeshi' ),
						'step_desc' => __( 'This is description', 'chambeshi' ),
						'step_btn_text' => __( 'Read More', 'chambeshi' ),
						'step_btn_link' => '#'
					],
					[
						'step_image' => Utils::get_placeholder_image_src(),
						'step_subtitle' => __( 'Sub title', 'chambeshi' ),
						'step_title' => __( 'This is step title 05', 'chambeshi' ),
						'step_desc' => __( 'This is description', 'chambeshi' ),
						'step_btn_text' => __( 'Read More', 'chambeshi' ),
						'step_btn_link' => '#'
					],
		...
		$this->add_control(
			'show_more_button',
			[
				'label' => __( 'Show More Button', 'chambeshi' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Show More Text', 'chambeshi' ),
				'type' => Controls_Manager::TEXT,
				'show_label' => true,
				'default' => __( 'More Steps', 'chambeshi' ),
				'condition' => [
					'show_more_button!' => '',
				],
			]
    ...
    $this->add_control(
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Show More Button', 'chambeshi' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'show_more_button!' => '',
				],
