<?php
namespace ChambeshiElementorWidgets\Widgets\TestimonialSlider;
...
class Widget_TestimonialSlider extends Widget_Base {
	...
	public function get_title() {
		return __( 'Testimonial Slider', 'chambeshi' );
	}
  ...
  public function get_icon() {
    ...
    $this->start_controls_section(
		...
		$this->add_control(
			'info_style',
			[
				'label' => __( 'Info Background', 'chambeshi' ),
				'type' => Controls_Manager::HEADING,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Arrows', 'chambeshi' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
