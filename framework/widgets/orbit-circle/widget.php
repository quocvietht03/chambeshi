<?php
namespace ChambeshiElementorWidgets\Widgets\OrbitCircle;
...
class Widget_OrbitCircle extends Widget_Base {
	...
	public function get_title() {
		return __( 'Orbit Circle', 'chambeshi' );
	}
