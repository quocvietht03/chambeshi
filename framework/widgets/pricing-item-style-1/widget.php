...
namespace ChambeshiElementorWidgets\Widgets\PricingItemStyle1;
...
class Widget_PricingItemStyle1 extends Widget_Base
{
	...
	{
		return __('Pricing Item Style1', 'chambeshi');
	}
	...
	protected function register_content_section_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'default' => esc_html__('/Month', 'chambeshi'),
			]
		);
		$this->add_control(
			'time',
		...
		$repeater->add_control(
			'list_strikethrough',
			[
				'label' => __('Enable Strikethrough', 'chambeshi'),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __('Yes', 'chambeshi'),
				'label_off' => __('No', 'chambeshi'),
				'return_value' => 'yes',
				'default' => 'no',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'list_content' => esc_html__('Face masks', 'chambeshi'),
						'list_strikethrough' => 'no',
					],
					[
						'list_content' => esc_html__('Geothermal Spa', 'chambeshi'),
						'list_strikethrough' => 'no',
					],
					[
						'list_content' => esc_html__('Aroma therapy', 'chambeshi'),
						'list_strikethrough' => 'no',
					],
				],
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'default' => esc_html__('Book Now', 'chambeshi'),
			]
		);
	...
	protected function register_style_content_section_controls()
	{
		...
		$this->add_control(
			...
			[
				'label' => __('Background Overlay Image', 'chambeshi'),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Background Images', 'chambeshi'),
				'type' => Controls_Manager::MEDIA,
				'default' => [
					'url' => '',
				],
		...
		$this->add_control(
			...
			[
				'label' => __('Description Info', 'chambeshi'),
				'type' => Controls_Manager::HEADING,
			]
		);
		$this->add_control(
		...
		$this->add_control(
			'info_color',
			[
				'label' => __('Text Info Color', 'chambeshi'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __('Button More Wrap Color', 'chambeshi'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
