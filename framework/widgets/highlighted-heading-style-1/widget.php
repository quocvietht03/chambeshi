...
namespace ChambeshiElementorWidgets\Widgets\HighlightedHeadingStyle1;
...
class Widget_HighlightedHeadingStyle1 extends Widget_Base
{
	...
	{
		return __('Highlighted Heading Style 1', 'chambeshi');
	}
	...
	protected function register_content_section_controls()
	{
		...
		$repeater->add_control(
			...
			[
				...
				'label_block' => true,
				'default' => __('Text Heading', 'chambeshi'),
			]
		);
		$repeater->add_control(
			'style_title',
			[
				'label' => __('Style', 'chambeshi'),
		...
		$this->add_control(
			'list',
			[
				'label' => __('List Style Heading', 'chambeshi'),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'text_title' => __('This is the heading', 'chambeshi'),
						'style_title' => '1'
					],
					[
						'text_title' => __('Highlighted', 'chambeshi'),
						'style_title' => '2'
					],
					[
						'text_title' => __('After heading', 'chambeshi'),
						'style_title' => '1'
					],
				],
		...
		$this->add_control(
			'link_heading',
			[
				'label'       => esc_html__('Link', 'chambeshi'),
				'type'        => Controls_Manager::TEXT,
				'input_type'  => 'url',
				'default'     => '',
			]
	...
	protected function register_style_content_section_controls()
	{
		...
		$this->add_control(
			...
			[
				'label' => __('Highlighted Text', 'chambeshi'),
