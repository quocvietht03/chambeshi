...
namespace ChambeshiElementorWidgets\Widgets\MobileMenu;
...
class Widget_MobileMenu extends Widget_Base
{
	...
	{
		return __('Mobile Menu', 'chambeshi');
	}
	...
	protected function register_content_section_controls()
	{
		...
		if ( ! empty( $menus ) ) {
			$this->add_control(
				'menu',
				[
					'label' => esc_html__( 'Menu', 'chambeshi' ),
					...
					'description' => sprintf(
						...
						esc_html__( 'Go to the %1$sMenus screen%2$s to manage your menus.', 'chambeshi' ),
			...
			$this->add_control(
				...
				[
					...
					'alert_type' => 'info',
					'heading' => esc_html__( 'There are no menus in your site.', 'chambeshi' ),
					'content' => sprintf(
						/* translators: 1: Link opening tag, 2: Link closing tag. */
						esc_html__( 'Go to the %1$sMenus screen%2$s to create one.', 'chambeshi' ),
	...
	protected function register_style_content_section_controls()
	{
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Main Menu', 'chambeshi'),
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__( 'Normal', 'chambeshi' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Text Color', 'chambeshi' ),
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__( 'Hover', 'chambeshi' ),
			]
		);
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__( 'Active', 'chambeshi' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Vertical Padding', 'chambeshi' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Toggle Offset', 'chambeshi' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', 'custom' ],
				'range' => [
					'px' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Sub Menu', 'chambeshi'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Additional Options', 'chambeshi'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'heading_toggle_menu',
			[
				'label' => esc_html__( 'Toggle Menu', 'chambeshi' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Divider Menu', 'chambeshi' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'divider_menu_style',
			[
				'label' => esc_html__( 'Style', 'chambeshi' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'none' => esc_html__( 'None', 'chambeshi' ),
					'solid' => esc_html__( 'Solid', 'chambeshi' ),
					'double' => esc_html__( 'Double', 'chambeshi' ),
					'dotted' => esc_html__( 'Dotted', 'chambeshi' ),
					'dashed' => esc_html__( 'Dashed', 'chambeshi' ),
				],
				'default' => 'solid',
				'selectors' => [
		...
		$this->add_control(
			'divider_menu_weight',
			[
				'label' => esc_html__( 'Width', 'chambeshi' ),
				'type' => Controls_Manager::SLIDER,
