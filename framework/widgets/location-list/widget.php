...
namespace ChambeshiElementorWidgets\Widgets\LocationList;
...
class Widget_LocationList extends Widget_Base
{
    ...
    {
        return __('Location List', 'chambeshi');
    }
    ...
    protected function register_layout_section_controls()
    {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'label_block' => true,
                'default' => __('Our Locations', 'chambeshi'),
            ]
        );
        $repeater->add_control(
            'location_address',
            [
                'label' => __('Address', 'chambeshi'),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => '',
            ]
        ...
        $repeater->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => __('Enquire', 'chambeshi'),
            ]
        );
        $repeater->add_control(
            'location_button_link',
            [
                'label' => __('Button Link', 'chambeshi'),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => '',
            ]
        ...
        $repeater->add_control(
            ...
            [
                'label' => __('Opening Hours', 'chambeshi'),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => __('Opening Hours', 'chambeshi'),
            ]
        );
        ...
        $nested_repeater->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => __('Monday To Friday', 'chambeshi'),
            ]
        );
        ...
        $nested_repeater->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => __('12:00 pm - 08:00 pm', 'chambeshi'),
            ]
        );
        $repeater->add_control(
            'location_time',
            [
                'label' => __('Time List', 'chambeshi'),
                'type' => Controls_Manager::REPEATER,
                'fields' => $nested_repeater->get_controls(),
                'default' => [
                    [
                        'sub_location_title' => __('Monday To Friday', 'chambeshi'),
                        'sub_location_hours' => __('12:00 pm - 08:00 pm', 'chambeshi'),
                    ],
                    [
                        'sub_location_title' => __('Saturday - Sunday', 'chambeshi'),
                        'sub_location_hours' => __('06:00 pm - 05:00 pm', 'chambeshi'),
                    ],
                ],
        ...
        $this->add_control(
            'list',
            [
                'label' => __('Location list', 'chambeshi'),
                'type' => Controls_Manager::REPEATER,
                'fields' => $repeater->get_controls(),
                'default' => [
                    [
                        'location_title' => __('Sydney Double Bay', 'chambeshi'),
                        'location_address' => __('66 Broklyn New Golden Street USA', 'chambeshi'),
                        'location_button' => __('Enquire', 'chambeshi'),
                        'location_button_link' => '#',
                        'location_opening_hours' => __('Opening Hours', 'chambeshi'),
                        'location_time' => [
                            [
                                'sub_location_title' => __('Monday To Friday', 'chambeshi'),
                                'sub_location_hours' => __('12:00 pm - 08:00 pm', 'chambeshi'),
                        ...
                        'location_email' => __('help@company.com', 'chambeshi'),
                        'location_phone' => __('+1(800)123-4566', 'chambeshi'),
                        'location_maps_zoom' => '12',
                    ],
                    [
                        'location_title' => __('Newport Beach', 'chambeshi'),
                        'location_address' => __('854 Avocado Ave. Street USA', 'chambeshi'),
                        'location_button' => __('Enquire', 'chambeshi'),
                        'location_button_link' => '#',
                        'location_opening_hours' => __('Opening Hours', 'chambeshi'),
                        'location_time' => [
                    ...
                    [
                        'location_title' => __('Waikoloa, USA', 'chambeshi'),
                        'location_address' => __('Waikoloa Beach Resort, Unit D-8 250 Waikoloa Beach', 'chambeshi'),
                        'location_button' => __('Enquire', 'chambeshi'),
                        'location_button_link' => '#',
                        'location_opening_hours' => __('Opening Hours', 'chambeshi'),
                        'location_time' => [
    ...
    protected function register_style_section_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __('Maps height', 'chambeshi'),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 213,
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Opening Hours', 'chambeshi'),
                'type' => Controls_Manager::HEADING,
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('List Time', 'chambeshi'),
                'type' => Controls_Manager::HEADING,
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                'label' => __('Hours Color', 'chambeshi'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Hours Typography', 'chambeshi'),
                'default' => '',
        ...
        $this->add_control(
            ...
            [
                'label' => __('Content Color', 'chambeshi'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Content Typography', 'chambeshi'),
                'default' => '',
                    ...
                    <div class="bt-location-list--item">
                                    ...
                                    <div class="bt-location-list--meta-item">
                                        <a href="<?php echo esc_url('mailto:' . $item['location_email']); ?>">
                                            ...
                                            <div class="bt-location-info">
                                                <h4><?php echo esc_html__('Email:', 'chambeshi'); ?></h4>
                                ...
                                <?php if (!empty($item['location_phone'])) : ?>
                                    <div class="bt-location-list--meta-item">
                                        <a href="<?php echo esc_url('tel:' . preg_replace('/[^0-9]+/', '', $item['location_phone'])); ?>">
                                            ...
                                            <div class="bt-location-info">
                                                <h4><?php echo esc_html__('Phone:', 'chambeshi'); ?></h4>
                        ...
                        <?php if ($index == 0) { ?>
                            <div class="bt-more-info active">
                                <span><?php echo esc_html__('Less Information', 'chambeshi') ?></span>
                        ...
                        <?php } else { ?>
                            <div class="bt-more-info">
                                <span><?php echo esc_html__('More Information', 'chambeshi') ?></span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                    <path d="M8.00053 10.6666C8.08826 10.6671 8.17524 10.6503 8.25646 10.6171C8.33769 10.584 8.41157 10.5351 8.47386 10.4733L12.4739 6.47329C12.5994 6.34776 12.6699 6.1775 12.6699 5.99996C12.6699 5.82243 12.5994 5.65216 12.4739 5.52663C12.3483 5.40109 12.1781 5.33057 12.0005 5.33057C11.823 5.33057 11.6527 5.40109 11.5272 5.52663L8.00053 9.05996L4.47386 5.53329C4.34633 5.42408 4.18228 5.36701 4.01449 5.37349C3.84671 5.37997 3.68755 5.44952 3.56882 5.56825C3.45009 5.68698 3.38053 5.84614 3.37405 6.01393C3.36757 6.18171 3.42464 6.34576 3.53386 6.47329L7.53386 10.4733C7.65803 10.5965 7.82563 10.6659 8.00053 10.6666Z" fill="#C2A74E" />
                                </svg>
                            </div>
