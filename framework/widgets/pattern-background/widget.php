<?php
namespace ChambeshiElementorWidgets\Widgets\PatternBackground;
...
class Widget_PatternBackground extends Widget_Base {
	...
	public function get_title() {
		return __( 'Pattern Background', 'chambeshi' );
	}
	...
	protected function register_style_content_section_controls() {
		...
		$this->add_group_control(
			...
			[
				'name' => 'overlay_color',
				'label' => __( 'Overlay Color', 'chambeshi' ),
		...
		$this->add_control(
			'pattern_image', [
				'label' => __( 'Image Repeat', 'chambeshi' ),
