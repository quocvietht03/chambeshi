...
namespace ChambeshiElementorWidgets\Widgets\SiteBoxPhone;
...
class Widget_SiteBoxPhone extends Widget_Base
{
	...
	{
		return __('Site Box Phone', 'chambeshi');
	}
	...
	protected function register_content_section_controls()
	{
		...
		$this->add_control(
			'phone_custom_enable',
			[
				'label' => __('Enable Custom', 'chambeshi'),
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'default' => esc_html__('Chat Us Anytime', 'chambeshi'),
				'condition' => [
					'phone_custom_enable' => 'yes',
				],
			]
		...
		$this->add_control(
			'phone',
			[
				'label' => esc_html__('Phone', 'chambeshi'),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'default' => '',
				'condition' => [
	...
	protected function register_style_content_section_controls()
	{
		...
		$this->start_controls_section(
			'section_style',
			[
				'label' => esc_html__('Content Box', 'chambeshi'),
		...
		$this->add_responsive_control(
			'content_gap',
			[
				'label' => __('Content Spacing', 'chambeshi'),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 8,
				],
		...
		$this->add_control(
			'phone_color',
			[
				'label' => __('Phone Color', 'chambeshi'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
			...
			<div class="bt-site-box-phone">
				...
				?>
					<a href="<?php echo esc_url('tel:' . preg_replace('/[^0-9]+/', '', $site_information['site_phone'])); ?>">
						...
						<div class="bt-site-box-phone--infor">
							<?php
							echo '<div class="bt-label">' . esc_html__('Chat Us Anytime', 'chambeshi') . '</div>';
							?>
							<?php
