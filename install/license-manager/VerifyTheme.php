...
if ( ! class_exists( 'VerifyTheme_Admin' ) ) {
  ...
  class VerifyTheme_Admin {
      ...
      public static function enqueue_admin_assets( $hook ) : void {
          ...
          wp_localize_script(
              ...
              [
                  ...
                  'strings'  => [
                      'confirm_import'            => __( 'Please activate the Theme License to unlock Demo Import, Plugin updates, and Official Support.', 'chambeshi' ),
                      'deactivate_confirm'        => __( 'Are you sure you want to deregister this license on this site?', 'chambeshi' ),
                      'please_enter_purchase_code'=> __( 'Please enter a purchase code.', 'chambeshi' ),
                      'ajax_error'                => __( 'AJAX error. Please try again.', 'chambeshi' ),
                      'verifying'                 => __( 'Verifying...', 'chambeshi' ),
                      'processing'                => __( 'Processing...', 'chambeshi' ),
                      'license_activated'         => __( 'License activated.', 'chambeshi' ),
                      'license_deactivated'       => __( 'License deactivated.', 'chambeshi' ),
                      'activation_failed'         => __( 'Activation failed.', 'chambeshi' ),
                      'deactivation_failed'       => __( 'Deactivation failed.', 'chambeshi' ),
                      'too_many_attempts'         => __( 'Too many attempts. Try again later.', 'chambeshi' ),
                      'unauthorized'              => __( 'Unauthorized', 'chambeshi' ),
                  ],
              ]
          );
      }
      ...
      public static function render_admin_page() : void {
          ...
          ?>
          <div class="wrap">
              <h1><?php esc_html_e( 'Envato Settings', 'chambeshi' ); ?></h1>
              <p>
                <?php esc_html_e( 'Enter your Envato purchase code to activate the theme on this domain.', 'chambeshi' ); ?>
                <?php esc_html_e('Find instructions on obtaining Envato discount codes by ', 'chambeshi'); ?>
                <a href="<?php echo esc_url('https://docs.beplusthemes.com/ProductRegistration/'); ?>" target="_blank"><?php esc_html_e('clicking here.', 'chambeshi'); ?></a>
              </p>

              <?php if ( $is_activated ) : ?>
                  <div class="notice notice-success"><p>
                      <?php printf( esc_html__( 'License activated on: %s', 'chambeshi' ), esc_html( $domain ) ); ?>
                  </p></div>
              <?php endif; ?>

              <table class="form-table">
                  <tr>
                      <th scope="row"><label for="verify_purchase_code"><?php esc_html_e( 'Purchase code', 'chambeshi' ); ?></label></th>
                      <td>
                          ...
                          <p class="description"><?php esc_html_e( 'Enter purchase code and click Activate.', 'chambeshi' ); ?></p>
                      </td>
                  </tr>
              </table>
