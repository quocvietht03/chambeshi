...
<?php do_action( 'chambeshi/import_pack/demo_install_package/before' ); ?>
...
<div class="ip-package-demo-list">
    ...
    <div class="ip-package-demo-item">
        <div class="preview-image">
            ...
            <div class="actions">
                <a href="<?php echo esc_url( $package_item['url_demo'] ) ?>" target="_blank" class="__action-preview-demo" title="<?php echo esc_attr( 'Preview demo', 'chambeshi' ); ?>">
                    <?php _e( 'Preview', 'chambeshi' ); ?>
                </a>
                <a href="javascript:" class="__action-import-demo" title="<?php echo esc_attr( 'Import demo', 'chambeshi' ); ?>" data-package-id="<?php echo esc_attr( trim( $package_item['package_name'] ) ); ?>">
                    <?php _e( 'Import', 'chambeshi' ); ?>
                </a>
            </div>
        </div>
...
<?php do_action( 'chambeshi/import_pack/demo_install_package/after' ); ?>
