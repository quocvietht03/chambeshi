...
if( ! function_exists( 'chambeshi_import_pack_scripts' ) ) {
    /**
     * Import pack load scripts
     *
     */
    function chambeshi_import_pack_scripts() {
        ...
        wp_localize_script( 'import-pack-js', 'import_pack_php_data', [
             ...
             * security
             */
            'template_nonce'    => wp_create_nonce( 'chambeshi_template_nonce' ),
            'callback_nonce'    => wp_create_nonce( 'chambeshi_callback_nonce' ),
            'download_package_nonce'  => wp_create_nonce( 'chambeshi_download_package_nonce' ),
            'extract_package_nonce'  => wp_create_nonce( 'chambeshi_extract_package_nonce' ),
            'restore_data_nonce'  => wp_create_nonce( 'chambeshi_restore_data_nonce' ),
            'backup_site_nonce'  => wp_create_nonce( 'chambeshi_backup_site_nonce' ),
    ...
    add_action( 'admin_enqueue_scripts', 'chambeshi_import_pack_scripts' );
}
