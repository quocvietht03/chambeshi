		...
		<div class="bt-container">
			<div class="bt-404-page">
				<div class="bt-404--infor">
					...
					<a class="bt-button" href="<?php echo esc_url(home_url('/')); ?>"><?php esc_html_e('Back To Home', 'chambeshi'); ?></a>
				</div>
				<div class="bt-404--image">
					<img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/404-min.jpg'); ?>" alt="" />
				</div>
			</div>
		</div>
	</div>
